...
public class Dialog_BuscarLineas extends javax.swing.JDialog {
    public Dialog_BuscarLineas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void BuscarDatosLineas(String valor){
        ...
        sql = "select * from inventariofcj.Datos_Lineas WHERE Lineas LIKE '%"+valor+"%'";
    ...
    private void Tabla_LineasMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Tabla_LineasMousePressed
        ...
        if (evt.getClickCount()==2){
            ...
            Menu_Facturas.setLineas(ID,Linea);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialog_BuscarLineas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Dialog_BuscarLineas dialog = new Dialog_BuscarLineas(new javax.swing.JFrame(), true);
